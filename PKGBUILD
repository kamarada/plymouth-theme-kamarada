...
package() {
    ...
    ln -s /usr/share/pixmaps/kamarada-logo-text-dark.png "$pkgdir/usr/share/plymouth/themes/kamarada/watermark.png"
    ...
    echo 'FILES=(/usr/share/pixmaps/kamarada-logo-text-dark.png)' > "$pkgdir/etc/mkinitcpio.conf.d/kamarada-logo-text-dark.conf"
    chmod 644 "$pkgdir/etc/mkinitcpio.conf.d/kamarada-logo-text-dark.conf"
}
